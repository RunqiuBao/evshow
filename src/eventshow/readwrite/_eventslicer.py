...
class EventSlicer:
    ...
    def get_events_byNumber(self, t_start_us_idx: int, t_end_us_idx: int) -> Dict[str, np.ndarray]:
        """Get events (p, x, y, t) by number
        Parameters
        ----------
        t_start_us_idx: index of the starting event
        t_end_us_idx: index of the end event
